...
import { LojaEfetivarComponnent } from './loja/efetivar/loja.efetivar.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: "loja-efetivar", component: LojaEfetivarComponnent, canActivate: [GuardaRotas] }
    ])
  ],
